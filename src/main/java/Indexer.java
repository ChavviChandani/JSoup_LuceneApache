    ...
    public static void parse(Path path) throws IOException
    {
        ...
        for (Element document : documents) {
            ...
            if (document.select("DOCNO").text().contains("FR")) {
                parseDoc.add(new TextField("DOCNO", document.select("DOCNO").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("PARENT", document.select("PARENT").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("TEXT", document.select("TEXT").text() + "", Field.Store.YES));
            } else if (document.select("DOCNO").text().contains("FB")) {
                parseDoc.add(new TextField("DOCNO", document.select("DOCNO").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("HT", document.select("HT").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("HEADER", document.select("HEADER").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("TEXT", document.select("TEXT").text() + "", Field.Store.YES));
                ...
                parseDoc.add(new TextField("HEADLINE", document.select("HEADLINE").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("TEXT", document.select("TEXT").text() + "", Field.Store.YES));
                ...
                parseDoc.add(new TextField("BYLINE", document.select("BYLINE").text() + "", Field.Store.YES));
                ...
                parseDoc.add(new TextField("BYLINE", document.select("BYLINE").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("TEXT", document.select("TEXT").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("GRAPHIC", document.select("GRAPHIC").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("TYPE", document.select("TYPE").text() + "", Field.Store.YES));
                parseDoc.add(new TextField("SUBJECT", document.select("SUBJECT").text() + "", Field.Store.YES));
            }
